    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-gray-500">Explora y gestiona el catalogo de activos</p>
        </div>
      ...
      <div className="card mb-6">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1">
            <input
              type="text"
              placeholder="Buscar por nombre, etiqueta o serie..."
              value={search}
        ...
        {filteredAssets.map(asset => (
          ...
          >
            ...
            <div className="text-sm text-gray-500 space-y-1">
              ...
              {asset.serial && <p>Serie: {asset.serial}</p>}
              {asset.site_name && <p>Sitio: {asset.site_name}</p>}
              {asset.custodian_name && <p>Custodio: {asset.custodian_name}</p>}
            </div>
      ...
      {filteredAssets.length === 0 && (
        <div className="text-center py-12 text-gray-500">
          No hay activos que coincidan con tu filtro.
        </div>
      )}
    </div>
  );
